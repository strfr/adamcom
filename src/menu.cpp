...
void show_manual()
{
    ...
    std::printf("║ /rpt MS text        Repeat text every MS milliseconds (use for text mode)   ║\n");
    ...
    std::printf("╠══════════════════════════════════════════════════════════════════════════════╣\n");
    std::printf("║ HEX MODE INLINE REPEAT (flags parsed from input)                            ║\n");
    std::printf("╠══════════════════════════════════════════════════════════════════════════════╣\n");
    std::printf("║ In HEX mode, add flags to input line to enable repeat:                      ║\n");
    ...
    std::printf("║                                                                             ║\n");
    std::printf("║ Examples:                                                                   ║\n");
    std::printf("║   FF FF FF -r              Hex: repeat every 1000ms                         ║\n");
    std::printf("║   AA BB -r -t 100          Hex: repeat every 100ms                          ║\n");
    std::printf("║   AA BB -id 0x03 -r        CAN Hex: repeat to specific ID                   ║\n");
    std::printf("╠══════════════════════════════════════════════════════════════════════════════╣\n");
    std::printf("║ TEXT MODE REPEAT (use /rpt command to avoid conflicts)                      ║\n");
    std::printf("╠══════════════════════════════════════════════════════════════════════════════╣\n");
    std::printf("║ In TEXT mode, raw text is sent directly. Use /rpt for repeat:               ║\n");
    std::printf("║   /rpt 500 hello           Repeat 'hello' every 500ms                       ║\n");
    std::printf("║   /rpt 100 -r test         Sends literal '-r test' (no conflict!)           ║\n");
    std::printf("║   /rs stop                 Stop inline repeat                               ║\n");
    std::printf("╠══════════════════════════════════════════════════════════════════════════════╣\n");
    std::printf("║ STRICT VALIDATION                                                           ║\n");
    std::printf("╠══════════════════════════════════════════════════════════════════════════════╣\n");
    std::printf("║ - HEX mode: Only valid hex chars (0-9, A-F). Flags: -r, -t MS, -id 0xNNN    ║\n");
    std::printf("║ - TEXT mode: Any text sent as-is. No flag parsing.                          ║\n");
    std::printf("║ - Invalid input rejected with clear error messages.                         ║\n");
    std::printf("╠══════════════════════════════════════════════════════════════════════════════╣\n");
